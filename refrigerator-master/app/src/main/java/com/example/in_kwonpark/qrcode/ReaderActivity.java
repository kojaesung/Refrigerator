...
public class ReaderActivity extends AppCompatActivity {
    ...
    private Button virtualmarket_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        virtualmarket_btn = (Button) findViewById(R.id.virtualmarket_btn);
        ...
        itemlist_btn.setOnClickListener(new View.OnClickListener(){ // 식자재 목록 버튼 클릭 시
            @Override
            public void onClick(View view) {
        ...
        virtualmarket_btn.setOnClickListener(new View.OnClickListener(){ // Virtual Market 버튼 클릭 시
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReaderActivity.this, VirtualScreenActivity.class);
                startActivity(intent);
            }
        });

        shopping_btn.setOnClickListener(new View.OnClickListener(){ // 쇼핑하기 버튼 클릭 시
            @Override
            public void onClick(View view) {
